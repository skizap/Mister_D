...
"""                                                            DucheTamvan :v....
	...
	| $    $     $        $     |$$ $ $ $    $ $ $ $ $ 
	| $$$$$       $ $ $ $
	___________\__/____________MISTER_D_____________________________|
	_________________________[ducheattack]__________________________
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '<<>> BY MISTER_D WE ARE ANONYMOUS WE ARE LEGION WE DO NOT FORGIVE WE DO NOT FORGET EXPECT US ! <<<>>'
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "<<>> BY MISTER_D WE ARE ANONYMOUS WE DO NOT FORGIVE WE DO NOT FORGET EXPECT US ! <<<>>"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
