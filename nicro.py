...
def usage():
	print '---------------------------------------------------'
	print 'to attack:'
        print '#Windows: nicro.py http://www.exemple.com'
        print '#Linux: python nicro.py http://www.exemple.com'
	print "\a"
print \
"""                          
   ...
   #                														 #
   #           Mister_D                                                      # 
   #           Script By Sunda Cyber Army <> DCA and NCT <>                  #
   #           My Facebook : https://www.facebook.com/jbochin      		     #
   #                                                                         #
   #                                                                         #  
   #                                                                         #
   ###########################################################################...
